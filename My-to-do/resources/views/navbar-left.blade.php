        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="/"  aria-expanded="false" aria-controls="submenu-1"><i class="fas fa-fw fa-user-circle"></i>Dashboard <span class="badge badge-success"></span></a>
                    </li>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="#"  aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fas fa-power-off mr-2"></i>logout</a>
                    </li>
                </ul>
            </div>
        </nav>
